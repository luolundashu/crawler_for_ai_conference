...
def create_web(paper_list,conference_name,key_word,id_name,paper_tppe,patience=20):
                ...
                for i in range(1000):
                    ...
                    if i>1:
                        try :
                            ...
                            time.sleep(2)
                            print('会议：{}__{}关键词{}加载第{}页'.format(conference_name,id_name,keyword,i))
                    ...
                    create_web(paper_list,conference_name,keyword,id_name,paper_tppe)
